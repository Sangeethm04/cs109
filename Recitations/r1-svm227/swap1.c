...
/*
Q0: What was passed?
A0: the address was passed into the method
Q1:Why did the code change x and y or why did it not change x and y?
A1:the code did not change x or y because  the pointer was not dereferenced and only the address was changed in the swap method.
*/
